...
Confluence.Templates.User.logo = function(opt_data, opt_ignored) {
  return '' + ((opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) ? '<a ' + ((opt_data.canView) ? ' ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '') + ' href="' + soy.$$escapeHtml("") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/s/zh_CN/7502/85262de2dab440f060366aadca149a69d65c1f59/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"></a>' : (opt_data.profilePictureInfo.anonymous) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/zh_CN/7502/85262de2dab440f060366aadca149a69d65c1f59/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u533f\u540d') + '" title="' + soy.$$escapeHtml('\u533f\u540d') + '">' : (opt_data.canView) ? '<a ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '" href="' + Confluence.Templates.User.userLinkUrl(opt_data) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.profilePictureInfo.uriReference) + '" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '"></a>' : '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/zh_CN/7502/85262de2dab440f060366aadca149a69d65c1f59/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '">');
};
if (goog.DEBUG) {
...
{browserName:g.friendlyName(),browserVersion:g.version(),pageId:d.get("page-id"),editMode:"slow",numEditors:d.get("max-number-editors")})}else if(c.indexOf("spaceEditingRestriction")!==-1){b=d.get("space-key");c=d.get("content-type")==="blogpost"?"\u60a8\u4e0d\u80fd\u7f16\u8f91\u6b64\u7a7a\u95f4\u535a\u5ba2":"\u60a8\u4e0d\u80fd\u7f16\u8f91\u6b64\u7a7a\u95f4\u9875\u9762";b=d.get("context-path")+"/spaces/viewspacesummary.action?key="+encodeURIComponent(b);b=d.get("content-type")==="blogpost"?a.format("\u00e8\u00af\u00b7\u00e6\u00b1\u0082 {0}\u00e7\u00a9\u00ba\u00e9\u0097\u00b4\u00e7\u00ae\u00a1\u00e7\u0090\u0086\u00e5\u0091\u0098{1} \u00e6\u0088\u0096\u00e6\u0082\u00a8\u00e7\u009a\u0084\u00e9\u0082\u0080\u00e8\u00af\u00b7\u00e4\u00ba\u00ba\u00e6\u008e\u0088\u00e4\u00ba\u0088\u00e6\u0082\u00a8\u00e5\u009c\u00a8\u00e6\u00ad\u00a4\u00e7\u00a9\u00ba\u00e9\u0097\u00b4\u00e2\u0080\u009c\u00e6\u00b7\u00bb\u00e5\u008a\u00a0\u00e5\u008d\u009a\u00e5\u00ae\u00a2\u00e2\u0080\u009d\u00e7\u009a\u0084\u00e6\u009d\u0083\u00e9\u0099\u0090\u00e3\u0080\u0082",
'<a href="'+b+'">',"</a>"):a.format("\u00e8\u00af\u00b7\u00e6\u00b1\u0082{0}\u00e7\u00a9\u00ba\u00e9\u0097\u00b4\u00e7\u00ae\u00a1\u00e7\u0090\u0086\u00e5\u0091\u0098{1}\u00e6\u0088\u0096\u00e6\u0082\u00a8\u00e7\u009a\u0084\u00e9\u0082\u0080\u00e8\u00af\u00b7\u00e4\u00ba\u00ba\u00e6\u008e\u0088\u00e4\u00ba\u0088\u00e6\u0082\u00a8\u00e5\u009c\u00a8\u00e6\u00ad\u00a4\u00e7\u00a9\u00ba\u00e9\u0097\u00b4\u00e2\u0080\u009c\u00e6\u00b7\u00bb\u00e5\u008a\u00a0\u00e9\u00a1\u00b5\u00e9\u009d\u00a2\u00e2\u0080\u009d\u00e7\u009a\u0084\u00e6\u009d\u0083\u00e9\u0099\u0090\u00e3\u0080\u0082",'<a href="'+b+'">',"</a>");c=a.MessageHandler.flag({type:"info",title:c,body:b,close:"manual"});h(c).addClass("spaceEditingRestriction")}};return e});require("confluence/module-exporter").safeRequire("confluence/page-message",function(a){require("ajs").toInit(a.displayPageMessage)});
}catch(e){WRMCB(e)};
;
try {
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_ignored) {
  return '<p class="comment-user-logo">' + ((opt_data.userInfo.userName == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/zh_CN/7502/85262de2dab440f060366aadca149a69d65c1f59/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u533f\u540d') + '" title="' + soy.$$escapeHtml('\u533f\u540d') + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml("") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/s/zh_CN/7502/85262de2dab440f060366aadca149a69d65c1f59/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"></a>' : '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + Confluence.Templates.User.userLinkUrl({username: opt_data.userInfo.userName}) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '"></a>') + '</p>';
};
if (goog.DEBUG) {
